...
class EqualConv2d(nn.Module):
    def __init__(
            self, in_channel, out_channel, kernel_size, stride=1, padding=0, bias=True, lr_mul=1.0, conv_transpose2d=False,
    ):
        super().__init__()
...
class ModulatedConv2dSp(nn.Sequential):
    def __init__(
        self,
        in_channel,
        out_channel,
