...
from models_new.stylegan2 import Generator
...
class pSp(nn.Module):
    ...
    def __init__(self, opts):
        ...
        self.decoder = Generator(z_dim=512, w_dim=512, c_dim=0, resolution=opts.stylegan_size, img_channels=3, embed_res=64)#
    ...
    def load_weights(self):
        if self.opts.checkpoint_path is not None:
            ...
            self.decoder.load_state_dict(ckpt['generator_smooth'], strict=False)
    ...
    def forward(self, x, resize=True, latent_mask=None, input_code=False, randomize_noise=True,
        ...
        images = self.decoder(z=codes) # [8, 3, 256, 256]
        if resize:
            images = self.face_pool(images) # [8, 3, 256, 256]
